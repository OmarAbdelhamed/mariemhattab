...
const Packs = ({ packsRef }) => {
  return (
    ...
    >
      ...
      <div className='flex flex-col  md:flex-row  items-center px-[20px] lg:p-0 lg:items-center lg:justify-center md:items-end justify-center md:justify-between gap-[20px] md:gap-[10px] lg:gap-[85px] lg:w-full max-w-[990px]'>
        <PacksCard
          title='جلسة إستشارية'
          sub='المدة 60 دقيقة'
